...
////
        monthlyRepository.save(new Monthly(1, Month.JANUARY, "2021", 500D, 1, 1, 20, 10.0, 1));
        monthlyRepository.save(new Monthly(2, Month.AUGUST, "2022", 500D, 1, 1, 20, 10.0, 1));
        monthlyRepository.save(new Monthly(3, Month.FEBRUARY, "2021", 500D, 1, 1, 20, 10.50, 1));
        monthlyRepository.save(new Monthly(4, Month.MARCH, "2022", 500D, 1, 1, 20, 0D, 1));
        monthlyRepository.save(new Monthly(5, Month.DECEMBER, "2021", 500D, 1, 1, 20, 10.0, 2));
        monthlyRepository.save(new Monthly(6, Month.MAY, "2021", 500D, 1, 1, 20, 10.0, 3));
...
//       System.out.println(results);
        ...
        double total = totalAnnualTaxReliefsService.getTotalAnnualReliefs("2022", 1.00, 0.50);
        ...
        System.out.println(CalculateAge.getAge("20/03/2021"));
