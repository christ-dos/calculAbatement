...
//        childRepository.save(new Child(1, "Benoit", "Evan", "24/05/2021", "01/05/2021",LocalDateTime.now(),"https://www.hdwallpaper.nu/wp-content/uploads/2015/03/New-Baby-Photos-Hd.jpg", "christine@email.fr"));
//        childRepository.save(new Child(2, "Bernard", "Alice", "20/02/2021", "24/03/2020", LocalDateTime.now(), "https://www.hdwallpaper.nu/wp-content/uploads/2015/03/Cute-Babies-HD-Wallpapers.jpg", "christine@email.fr"));
...
//        List<Child> children = (List<Child>) childService.getChildrenByUserEmailOrderByBeginContractDesc();
